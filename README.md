...
If you have any issues with your custom domain or HTTPS, you can use this config file as a guide:
https://github.com/jimthoburn/wordpress-content-example/blob/main/html/wp-config-sample-render.php
...
It’s a good idea to make a full backup of both MySQL and your WordPress files. Using a plugin like “Jetpack” is one way to do this:
https://jetpack.com/blog/how-to-back-up-your-wordpress-site/

And here’s another example, using GitHub:
https://github.com/jimthoburn/wordpress-blueprint
